module.exports = getMessages = type => {
  return {
    STEP_1: 'Step 1/7 Completed: All required inputs available',
    STEP_2: `Step 2/7 Completed: ${type} found successfully and available to buy`,
    STEP_3: `Step 3/7 Completed: Balance available to buy the ${type}`,
    ...
    STEP_7: `Step 7/7 Completed: ${type} bought successfully`,
    FIELDS_ABSENT: 'Malformed Request, fill all fields',
    ALREADY_BOUGHT: `${type} already bought`,
    NOT_EXIST: `${type} doesn't exist`,
